(function () {
    ...
    angular
        .module('app')
        .controller("csvSettingsController", function($scope,$http,dataService) {
            $scope.real_name_gsm = "GSM_T";
            $scope.local = {};
            $scope.local.data_name = "gsm";
            $scope.local.colu = dataService.messages.csvview;
            ...
            $scope.update = function(){
                ...
                $http.post('/', JSON.stringify({"type" : "csvview","data" : $scope.local.colu}));
            };
