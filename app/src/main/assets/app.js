                       ...
                       if (window.location.href.indexOf('android_asset') == -1)
                           ...
                           dynamicScript.onload = function(){
                            for(var i=0;i<$scope.itemlist.length;i++){
                                $scope.itemlist[i]['price1'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['price1'];
                                $scope.itemlist[i]['price2'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['price2'];
                                $scope.itemlist[i]['price3'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['price3'];
                                $scope.itemlist[i]['count'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['count'];
                                $scope.itemlist[i]['count_unit'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['count_unit'];
                                $scope.itemlist[i]['currency_name'] = data['items'][$scope.itemlist[i][["\u041a\u043e\u0434"]]]['currency_name'];
                            }
